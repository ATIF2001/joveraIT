...
function Contact_us({ lang }) {
    ...
    branches: [
      {
        ...
        address:
          lang === "en"
            ...
            : "8نادي الجزيرة - البرج أ، شارع المروّر - الطابق",
      },
      {
      ...
      },
      {
        ...
        address:
          lang === "en"
            ? "Sharjah - Muwaileh Commercial - Office No.01G"
            : "الشارقة - المويهل التجاري / الشارقة - المكتب رقم 01G",
      },
      {
  ...
  const maps = {
    abuDhabi: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11563.201869038848!2d54.3894629!3d24.4539698!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e69246c2e264f%3A0x29be66f81d19a043!2sJovera%20Group!5e0!3m2!1sen!2sae!4v1702213879032!5m2!1sen!2sae",
    ajman: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3603.5010964530893!2d55.4884969759352!3d25.421505522577796!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5754f3ec329f%3A0x9cede73b696a0edb!2sJovera%20Group%20LLC!5e0!3m2!1sen!2sae!4v1766816741071!5m2!1sen!2sae",
    sharjah: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d115408.8775179337!2d55.46387618152094!3d25.32007697035517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f5f5fede7964b%3A0x2a830aa19c1f6d89!2sSharjah!5e0!3m2!1sen!2sae!4v1766817806068!5m2!1sen!2sae",
    dubai: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d462564.23174555483!2d54.60363676143995!3d25.075340989067737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43496ad9c645%3A0xbde66e5084295162!2sDubai!5e0!3m2!1sen!2sae!4v1766817704286!5m2!1sen!2sae",
  };
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className={`${lang === "en" ? "order-2" : "order-1"}`}>
              {[{ key: "dubai", data: texts.branches[1] }, { key: "ajman", data: texts.branches[3] }].map((branch) => (
                <div
                  key={branch.key}
                  onClick={() => setActiveBranch(branch.key)}
                  className={`min-h-[100px] p-4 mb-5 rounded-xl cursor-pointer flex items-center transition-all duration-300
                  ${lang !== "en" ? "flex-row-reverse text-right gap-2" : "gap-4"}
                  ${activeBranch === branch.key ? "bg-gradient-to-r from-[#D7AA47] to-[#715925]" : "bg-[#1B1B1B] hover:bg-[#242424]"}`}
                >
                  <div>
                    <MapPin width={28} height={28} />
                  </div>
                  <div>
                    <h4 className="text-lg font-semibold">{branch.data.title}</h4>
                    <p className="text-sm">{branch.data.address}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className={`${lang === "en" ? "order-1" : "order-2"}`}>
              {[{ key: "abuDhabi", data: texts.branches[0] }, { key: "sharjah", data: texts.branches[2] }].map((branch) => (
                <div
                  key={branch.key}
                  onClick={() => setActiveBranch(branch.key)}
                  className={`min-h-[100px] p-4 mb-5 rounded-xl cursor-pointer flex items-center transition-all duration-300
            ...
            {/* Help & Support */}
            <div className={`${lang !== "en" ? "text-right" : ""} mt-10 sm:col-span-2`}>
              <h2 className="text-xl font-semibold mb-6">{texts.helpSupport}</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {texts.contactItems.map((item, idx) => {
                  let href = "#";

                  if (item.icon === Phone || item.icon === Smartphone) {
                    href = `tel:${item.text.replace(/\s+/g, "")}`;
                  } else if (item.icon === FaWhatsapp) {
                    href = `https://wa.me/${item.text.replace(/\D/g, "")}`;
                  ...
                  return (
                    <a
                      ...
                      className={`flex items-center p-4 bg-[#1B1B1B] rounded-lg ${lang !== "en" ? "flex-row-reverse gap-2" : "gap-4"}`}
                    >
